    ...
    <div class="col-lg-6 col-xs-12">
        <div class="form">
            <form method="POST" action="{{ route('register') }}">
                @csrf
                <input type="text" placeholder="Name" class="form-control input-box @error('name') is-invalid @enderror" name="name" required> 
                ...
                <input type="password" placeholder="Confirm Password" class="form-control input-box @error('password-confirm') is-invalid @enderror" name="password_confirmation" required>
                <p>This page is protected by reCAPTCHA, and subject to the
                Google Privacy Policy and Terms of service.</p>
                <input type="submit" name="" id="" value="Register" class="input-btn">
            </form>
            <a href="{{route('login')}}">
                <button name="" id="" class="input-btn"> Login </button>
            </a>
